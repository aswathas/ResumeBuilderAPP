...
import com.itextpdf.io.image.ImageData;  // Add this import
...
public class PdfGenerator {
    ...
    private void addHeader(Document document, Resume resume, String imagePath, PdfFont headerFont, PdfFont bodyFont) {
        try {
            ...
            // Add name and contact information first
            ...
            // Add image if available - Updated image handling code
            if (imagePath != null && !imagePath.trim().isEmpty()) {
                try {
                    // Create image data directly from the file path
